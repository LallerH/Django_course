...
#         # min_value = min(queryset, key=lambda x: x.product_price).product_price
#         # max_value = max(queryset, key=lambda x: x.product_price).product_price
#         min_value = queryset.aggregate(min_value=models.Min('product_price'))['min_value']
#         max_value = queryset.aggregate(max_value=models.Max('product_price'))['max_value']
#         step = 50
...
#             return queryset.filter(product_price__gte=start, product_price__lte=end)
#         return queryset
